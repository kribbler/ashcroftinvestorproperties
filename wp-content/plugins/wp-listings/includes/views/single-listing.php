...
function single_listing_post_content() {
	...
	<div class="full_width_gray">
		<div class="container page-content inner-page">
			<div class="row">
				<div class="span6">
...
while ( have_posts() ) : the_post();
	//function moved in /appic-child/functions.php by daniel
	d_get_single_listing_post_content();
endwhile;
/** bellow code is overwritten by DANIEL
/*
