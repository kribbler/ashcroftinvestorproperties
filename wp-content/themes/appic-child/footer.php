...
jQuery(document).ready(function($){
	...
	var visible_tab = 1;
	$('#tab_1_title').addClass('visible_tab');
	$('#tab_2_title').removeClass('visible_tab');
	...
	/*$('.open_detail').toggle(
		...
		function(){
			...
			$('#lis_des_' + id).slideUp('fast');
		}
	);*/

	$('.open_detail').live('click', function() {
...
jQuery(document).ready(function($){
	if ($("#tdp-2 option[value='already-built']").length > 0){
		$('#tdp-2').val('already-built');
	}
	if ($("#tdp-2 option[value='house-land-packages']").length > 0){
		$('#tdp-2').val('house-land-packages');
	}
});
</script>
