...
@font-face {
 ...
 src: url('fonts/Geometria.eot') !important;
...
ul#navigation .current-menu-parent > a {
	color: #46a3da !important;
	background: none !important;
	border-bottom: 2px solid #4aa8dd;
}
...
<?php if (get_theme_option('show_top_lines')) : ?>
	<div class="top-nav">
		<div class="container">
			...
			What our Customers are saying right now:&nbsp;&nbsp;<?php echo quoteRotator(); ?>
			</p>
		...
		<div class="foto-pattern">
			<div class="container">
				...
				if ($_SERVER['REMOTE_ADDR'] == '::1') 
					echo do_shortcode('[content_block id=248 ]');
				else 
